 ...
 *
 * Sets up and configures the CategoryAdmin module
 *
...
class Module implements InitProviderInterface, ConfigProviderInterface, AutoloaderProviderInterface
{
    ...
    {
        if (!defined('CATEGORY_ADMIN_MODULE_ROOT')) {
            define('CATEGORY_ADMIN_MODULE_ROOT', realpath(__DIR__));
        }
    }
